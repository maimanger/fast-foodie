...
const SearchBar = () => {
    return (
        <div className={"input-group homescreen-search-bar"}>
            ...
            <input type={"text"} className={"form-control homescreen-search-input-location d-none d-lg-inline"} placeholder={"City State"} />
