        ...
        <div className={"homescreen-search-bar w-100 d-flex"}>
            <div className={"d-flex w-100"}>
                ...
                <div className={"homescreen-search-bar-left-part d-flex px-0 w-100"}>
                    ...
                    <label className={"d-flex bg-light px-3 fw-bold rounded-start align-items-center"}
                ...
                <div className={"homescreen-search-bar-location w-100 border-start bg-white position-relative d-none d-xl-inline-flex"}>
                    ...
                    {/*******************   location dropdown   *******************/}
                    <div className={"homescreen-search-bar-location-dropdown position-absolute w-100 p-3 bg-light z"}>
                        <div className={""}>
