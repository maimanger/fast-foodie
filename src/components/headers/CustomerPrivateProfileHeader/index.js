...
const CustomerPrivateProfileHeader = () => {
    ...
    return (
        <div className={"searchscreen-search-header-container bg-white w-100 px-5 py-4 m-0 justify-content-between align-items-top row sticky-top"}>
            ...
            <div className={"col-xl-7 col-lg-6 col-md-7 col-sm-9 col-8"}>
                <div className={"searchscreen-search-header-searchbar-container"}>
                    <SearchBar profile={profile}/>
                </div>
                {/*<Dropdowns />*/}
            </div>
            <div className={"searchscreen-search-header-buttons d-flex justify-content-end align-items-center col-lg-2 col-md-4 col-sm-2 col-2"}>
...
export default CustomerPrivateProfileHeader;