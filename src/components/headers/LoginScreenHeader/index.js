...
const LoginScreenHeader = ({loggedIn=true}) => {
    ...
    return (
        ...
        <div className={"w-100 d-flex justify-content-center align-items-center px-5 py-2 m-0 position-relative"}>
            ...
            <div className={"searchscreen-search-header-buttons searchscreen-simple-header-buttons position-absolute"}>
                {(profile !== undefined && Object.keys(profile).length !== 0) && <LoggedInHeaderButtons />}
            </div>
        </div>
            </div>
    )
